...
public class Main {
    ...
    public static boolean canPlaceHorizontally(char[][] arr, String word, int row, int col) {
        ...
        // CHECK THE LAST -- if cell exists then it must be '+'
        ...
        for (i = 0; i < word.length(); i++) {
            /* DON'T FORGET TO WRITE THE FOLLOWING CONDITION */
    ...
    public static boolean canPlaceVertically(char[][] arr, String word, int row, int col) {
        ...
        // CHECKING THE LAST
        // if (row + word.length() < arr.length && arr[row + word.length()][col] != '+')
        // // this is wrong
        // return false;
        ...
        for (i = 0; i < word.length(); i++) {
             ...
             * --> FAVOURABLE CONDITION <-- (favourable condition 1 || falvourable cond. 2
             * || fav. cond. 3 || .... so on ... )
             * ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
             * ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
             * 
             ...
             * vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
             * --> UNFAVOURABLE CONDITION <-- (unfavourable condition 1 && unfalvourable
             * cond. 2 && unfav. cond. 3 && .... so on ... )
             * ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
             * ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
             * 
             */
